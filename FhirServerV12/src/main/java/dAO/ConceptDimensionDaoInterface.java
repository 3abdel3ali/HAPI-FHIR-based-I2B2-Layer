...
import entity.ConceptDimension;
import entity.PatientDimension;

/**
 * 
 * 
 * DAO of the i2b2 Concept Dimension Table
 * 
 */
public interface ConceptDimensionDaoInterface extends
		GenericDao<ConceptDimension, Serializable> {
